...
export const MainListItems = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Link to="/calculateur" className="no-underline">
        <ListItemButton>
          <ListItemIcon>
            <PregnantWomanOutlinedIcon color="primary" />
          </ListItemIcon>
          <ListItemText primary="Calculateur de grossesse" />
        </ListItemButton>
      </Link>
      ...
      <Link to="/Compte-rendu" className="no-underline">
        <ListItemButton>
          <ListItemIcon>
            <ArticleOutlinedIcon color="primary" />
          </ListItemIcon>
          <ListItemText primary="Compte rendu" />
        </ListItemButton>
      </Link>
      <Link to="/observation" className="no-underline">
        <ListItemButton>
          <ListItemIcon>
            <MedicalInformationOutlinedIcon color="primary" />
          </ListItemIcon>
          <ListItemText
            primary="Observation Clinique
"
          />
        </ListItemButton>
      </Link>
...
export function SecondaryListItems({}: Props) {
  ...
  return (
    <React.Fragment>
      ...
      <Divider />
      <Link to="/fichiers" className="no-underline">
        <ListItemButton>
          <ListItemIcon>
