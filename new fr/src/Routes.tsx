...
import BirthCalculator from "./pages/OperationPagesUpdated/BirthCalculator";
import BirthCalculatorPage from "./pages/BirthCalculatorPage";
import AddBirthCalculation from "./pages/AddForms/AddBirthCalculation";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "calculateur",
        element: <BirthCalculatorPage />,
      },
      {
        path: "ajouter-calculateur",
        element: <AddBirthCalculation />,
      },
      {
        path: "bloodtest",
